...
| **VALID (đúng, dùng nguyên)** | 1 | 25% |
| **INVALID (sai; loại bỏ)** | 0 | 0% |
| **INCOMPLETE (chấp nhận sau khi sửa)** | 3 | 75% |

## **5\. Kết luận — Khi nào nên / không nên dùng AI?**

- **Nên dùng:** Dùng để tạo các dàn bài, kịch bản test mẫu, giải thích các khái niệm cơ bản hoặc tóm tắt tài liệu. Đặc biệt hữu ích khi thiết kế các template ban đầu.
- **Không nên dùng:** Không nên tin tưởng tuyệt đối vào khả năng phân tích nguyên nhân gốc rễ (Root Cause Analysis) hay số liệu log phức tạp. Không dùng đề xuất tối ưu kỹ thuật chuyên sâu mà chưa qua kiểm chứng, đặc biệt dễ bị ảo giác (hallucination) đối với các lỗi liên quan đến kiến trúc như CPU-bound vs I/O-bound.
